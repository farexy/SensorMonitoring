...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    final String URL = "http://192.168.1.7:24688/api/user/login/";
    ...
    private void login(){
        ...
        try{
            jsonBodyObj.put("email", ((TextView)findViewById(R.id.email)).getText().toString());
            jsonBodyObj.put("password", ((TextView)findViewById(R.id.password)).getText().toString());
    ...
    View.OnClickListener login = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(!DB.Users.containsKey(email)){
                showError("Eamil or password incorrect");

            } else{
                if(DB.Users.get(email).getPassword().equals(password)){
                    Session.setUser(DB.Users.get(email));
    ...
    //private Button mRegistrateButton;
    private AlertDialog alert;

    private OnClickListener registrateButton_onClick = new OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mRegistrateButton = (Button)findViewById(R.id.registrate_button);
        mRegistrateButton.setOnClickListener(registrateButton_onClick);
        ...
        mEmailSignInButton.setOnClickListener(login);
